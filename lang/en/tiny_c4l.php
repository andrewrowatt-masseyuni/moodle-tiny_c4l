...
$string['clipboard_copy'] = 'Copy';
$string['clipboard_cut'] = 'Cut';
$string['clipboard_paste'] = 'Paste';
$string['clipboard_copy_success'] = 'Component copied! Close this dialog, move to the new location, click C4L, and select Paste.';
$string['clipboard_cut_success'] = 'Component cut! Close this dialog, move to the new location, click C4L, and select Paste.';
$string['clipboard_paste_success'] = 'Component pasted successfully.';
$string['clipboard_no_component'] = 'No C4L component found at cursor position.';
$string['clipboard_empty'] = 'Clipboard is empty.';
