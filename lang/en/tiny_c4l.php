...
$string['mu-clipboard_alert_title'] = 'Notice';
$string['mu-clipboard_copy'] = 'Copy';
$string['mu-clipboard_copy_disabled'] = 'No C4L component selected';
$string['mu-clipboard_copy_enabled'] = 'A C4L component is selected in the editor. Click to copy.';
$string['mu-clipboard_copy_success'] = 'Component copied! Close this dialog, move to the new location, click Edit, then Paste.';
$string['mu-clipboard_cut'] = 'Cut';
$string['mu-clipboard_cut_disabled'] = 'No C4L component selected';
$string['mu-clipboard_cut_enabled'] = 'A C4L component is selected in the editor. Click to cut.';
$string['mu-clipboard_cut_success'] = 'Component cut! Close this dialog, move to the new location, click Edit, then Paste.';
$string['mu-clipboard_empty'] = 'Clipboard is empty.';
$string['mu-clipboard_no_component'] = 'No C4L component found at cursor position.';
$string['mu-clipboard_paste'] = 'Paste';
$string['mu-clipboard_paste_disabled'] = 'Clipboard is empty';
$string['mu-clipboard_paste_enabled'] = 'Paste C4L component from clipboard';
$string['mu-clipboard_paste_success'] = 'Component pasted successfully.';
