...
$string['mu-blue'] = 'Blue';
$string['mu-checkmark'] = 'Checkmark';
$string['mu-comment'] = 'Comment';
$string['mu-explore'] = 'Explore';
$string['mu-green'] = 'Green';
$string['mu-grey'] = 'Grey';
$string['mu-group'] = 'Group';
$string['mu-guidance'] = 'Guidance';
$string['mu-important'] = 'Important';
$string['mu-information'] = 'Information';
$string['mu-listen'] = 'Listen';
$string['mu-map'] = 'Map';
$string['mu-others'] = 'Massey (Other)';
$string['mu-process'] = 'Process';
$string['mu-questionmark'] = 'Question mark';
$string['mu-read'] = 'Read';
$string['mu-table'] = 'Table (Yellow)';
$string['mu-table-grey-variant'] = 'Table (Grey)';
$string['mu-tables'] = 'Tables';
$string['mu-teal'] = 'Teal';
$string['mu-voilet'] = 'Voilet';
$string['mu-watch'] = 'Watch';
$string['mu-write'] = 'Write';
$string['mu-yellow'] = 'Yellow';
