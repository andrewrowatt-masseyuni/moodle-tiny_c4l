...
$string['mu-clipboard_copy_enabled'] = 'Copy the selected C4L component';
$string['mu-clipboard_copy_success'] = 'Component copied! Close this dialog, move to the new location, click C4L, and select Paste.';
$string['mu-clipboard_cut'] = 'Cut';
$string['mu-clipboard_cut_disabled'] = 'No C4L component selected';
$string['mu-clipboard_cut_enabled'] = 'Cut the selected C4L component';
$string['mu-clipboard_cut_success'] = 'Component cut! Close this dialog, move to the new location, click C4L, and select Paste.';
